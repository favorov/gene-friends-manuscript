...
Of note, mapping \eqref{def:correction} coincides with the semi-discreet optimal transportation (under quadratic Euclidean cost) of a uniform distribution on an equally-spaced grid of integers to continuous uniform distribution on $[0, 1]$ (see \cite{Solomon2018OptimalTO}).
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering       \includegraphics[width=\textwidth]{trololo}
         \caption{Support of $r_{\sigma}$ for $k=3$.}
         \label{fig:polytop}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
\includegraphics[width=\textwidth]{trololo1}
         \caption{Support of $r_{\sigma}$ if $r_{\sigma(2)} - r_{\sigma(1)} \ge w$}
         \label{fig:small_polytope}
     \end{subfigure}
\end{figure}
