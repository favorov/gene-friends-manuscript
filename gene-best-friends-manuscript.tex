...
Let's make a generalisation. We have entities and features and a matrix that show how strong is a feature related to an entity. Sometimes, observation of a feature is enough to conclude that an entity is active. In the simplest case, we want to identify those features that reliably and uniquely identify an entity. Let's call the feature the entity's marker and let's call the entity the feature's best friend. Also, a feature can mark more than one entity. 

Here, we describe a rank test identifying significant pairs of marker feature and its best friend entity.
%
\section{Method}
\subsection{Ranking}
