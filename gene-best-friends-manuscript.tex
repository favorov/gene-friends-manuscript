...
\textcolor{violet}{\begin{itemize}
    ...
    \item double-ranking is applicable to the case of clouds of different nature (e.g. different data modalities such as ATACSeq and RNASeq)
\end{itemize}}
...
For information retrieval the tags are usually (see, e.g. \cite{liu2009learning}) queries and clouds are documents. 
