...
%
\author{
Alexandra Suvorikova \inst{1} \and Alexey Kroshnin \inst{1}  \and Vasily Ramensky \inst{2,3,4} \and Vera Mukhina \inst{5,6} \and Ludmila Danilova\inst{8} \and Andrey Mironov \inst{4,7} \and Alexander Favorov\inst{6,8}}
%
...
% If a feature has a substantial weight in only one process, it is referred to as a marker \cite{stein-obrien_patternmarkers_2017}. 
